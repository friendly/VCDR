...
%\sectionfont{\color{partcol0}\sffamily\selectfont}
...
%\usepackage{showidx}
%\input{inputs/showindex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Chapter title pages and section colors
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
.chapter <- 11    # ordinal number of chapter to compile e.g. "ch08" -> 8 ... "ch11" -> 11
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \colorlet{sectcol}{col1!80!black}      % section/subsection titles
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \colorlet{sectcol}{col2!80!black}      % section/subsection titles
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \colorlet{sectcol}{col3!80!black}      % section/subsection titles
...
@
<<ch10, child=includes('ch10')>>=
@

<<ch11, child=includes('ch11')>>=
@
