...
%% Define page style parameters -- here, still draft style
\input{inputs/pagestyle-draft}
...
.chapter <- 8
.pages <- c(1, 29, 61, 113, 159, 217, 253, 347, 425)  # starting page number
cat("\\setcounter{chapter}{", .chapter-1, "}", sep="")
cat("\\setcounter{page}{", .pages[.chapter]-1, "}", sep="")
chapters <- sprintf("ch%02d", 1:9)
