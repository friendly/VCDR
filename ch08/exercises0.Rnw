\begin{enumerate}
  ...
  \item \exref{ex:vision-glm} presented an analysis of the data on visual acuity 
...
@
  ...
  \item \tabref{tab:birthcontrol} gives a $4 \times 4$ table of opinions about
...
\input{ch08/tab/birthcontrol}
  ...
  \item The data set \data{gss8590} in \pkg{logmult} gives a $4 \times 5 \times 4$
