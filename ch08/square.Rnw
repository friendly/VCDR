...
vcdExtra::summarise(glmlist(hauser.indep, hauser.quasi))
@
...
<<hauser2-ord2>>=
vcdExtra::summarise(glmlist(hauser.indep, hauser.UA, 
                            hauser.roweff, hauser.RC))
@
...
vcdExtra::summarise(glmlist(hauser.CR, hauser.CRdiag))
@
