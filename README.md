...
File structure
--------------
Book files:  `book.Rnw` is the main source file.  Chapters are
...
I haven't yet begun to use sub-child documents for sections within
chapters.


```
book.Rnw  - Main source file; compile with knit2pdf("book.Rnw")
ch01.Rnw
ch02.Rnw
Ch03.Rnw
Ch04.Rnw
...
has to be re-done with changes to the text.
...
* Data sets:  Use `\data{HorseKicks}`. Will be automatically indexed.

### Indexing
In addition to the automatic indexing for R stuff, I use some shorthands:
