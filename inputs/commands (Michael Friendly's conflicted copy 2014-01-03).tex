...
\newcommand {\VCD}{\emph{VCD} }
%\newcommand*{\macro}[1]{\texttt{#1} macro\ixm{#1}}
%\newcommand*{\macparm}[1]{\texttt{#1} parameter}
...
%\newif\ifmacrolistings
%\macrolistingsfalse
%\newcommand{\macrolisting}[1]{%
%  \ifmacrolistings
