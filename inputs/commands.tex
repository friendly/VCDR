...
\providecommand{\blacksquare}{\rule{1.4ex}{1.4ex}}
...
\newcommand{\tableheader}{\rowcolor{partcol2}} % use light part color
...
% FIXED: problem with extra space before punctuation
