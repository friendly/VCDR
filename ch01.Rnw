...
the \ctab. 
\ix{data!frequency form} 
For example, in the \data{Arthritis} data, ignoring \var{Sex}
...
\ixon{data analysis!hypothesis testing approach} 
\ixon{hypothesis testing}
...
\ixoff{data analysis!hypothesis testing approach} 
\ixoff{hypothesis testing}

\subsection{Model building approaches}
\ixon{data analysis!model building} 
\ixon{model building}
...
\ix{statistical analyses!logistic regression} 
...
\ixon{statistical analyses!logistic regression}
...
\ixoff{statistical analyses!logistic regression} 
\ixoff{logistic regression}
\ixoff{data analysis!model building} 
\ixoff{model building}
...
\ixon{graphics!analysis graphics}
...
\ixoff{graphics!analysis graphics}

\ixon{graphics!presentation graphics}
...
\ixoff{graphics!presentation graphics}
...
%% This figure re-uses the images from Chapter 4, Fig 4.5, \figref{fig:berk-fourfold3}
%% and Chapter 4, Fig 4.19, \figref{fig-mammograms1}.
\begin{figure}[!b]
  \centering
...
\ixoff{variable!effect ordering}
...
<<cleanup01, include=FALSE, purl=FALSE>>=
