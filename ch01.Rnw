...
Statistical methods for the analysis for categorical data can be classified into two
broad categories:
...
the \term{phi coefficient}, $\phi = \sqrt{\chi^2 / N} = 0.483$, 
and \term{Cramer's V}, $V = \sqrt{\chi^2 / N \min(r-1,c-1)} = 0.279$
