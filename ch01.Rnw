...
\TODO{DM: What about explorative analysis?}
...
\TODO{Use brackets instead of parentheses?}
...
\TODO{Remove Donner party example to shorten up the intro? One example
...
\TODO{Add frequency table here? Make it easier to compare with mosaic plot}
...
\TODO{either show graph or remove code.}
...
\TODO{Remove this section if parallel coordinates plots are removed
  from Sec. 5.7}
...
\TODO{Maybe remove coda: example is quite long already.}
