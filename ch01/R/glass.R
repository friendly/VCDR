# Demonstrate effect ordering

# fixed: use rot_labels to avoid overlapping text labels.

# TODO: add Glass data to vcdExtra
...
cd("C:/Dropbox/Documents/VCDR/ch01/fig")
