...
\begin{itemize}
    ...
    Models are simplifed descriptions of data.  In \secref{sec:mosaic-struc} we use mosaic
...
%    to illustrate the differences among models for ordinal variables in terms of log odds ratios.
    ...
    The model-bulding methods described in \chref{ch:logistic}--\chref{ch:glm} make frequent
