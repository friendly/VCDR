...
chapters <- sort(c(sprintf("ch%02d", 1:9), "ch07b"))
#includeonly = c("ch01", "ch02", "ch03", "ch04")
includeonly <- chapters[1:10]
...
\part[Introduction]%
{Introduction\\[4ex]\includegraphics[width=\textwidth]{ch01/fig/presentation-exploration2}}
...
{Exploratory and Hypothesis-testing Methods\\[4ex]\includegraphics[width=\textwidth,trim=80 50 80 50]{ch04/fig/berk-fourfold4-1}}
...
{Model-building Methods\\[4ex]\includegraphics[width=\textwidth]{ch07/fig/arth-po-eff2-1}}
