...
\citet[Section D.6]{Fox:2015}, available online.
}
...
<<ordplot3plot, h=6, w=6, out.width='.48\\textwidth', cap='Ord plots for the Federalist (left) and WomenQueue (right) data sets.', echo=FALSE>>=
Ord_plot(Federalist, main = "Instances of 'may' in Federalist Papers",
         gp=gpar(cex=1), pch=16)
...
\citet{LindseyMersch:92}, \citet[Section 6.1]{Lindsey:95} shows how various discrete
(and continuous)
