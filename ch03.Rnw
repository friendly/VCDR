...
<<arbuthnot1, echo=2:11, h=4, w=7, out.width=".75\\textwidth", cap="Arbuthnot's data on male/female sex ratios in London, 1629--1710, together with a (loess) smoothed curve (blue) over time and the mean Pr(Male)", scap="Arbuthnot's data on male/female sex ratios">>=
...
\TODO{PC: Is spar() a typo? What does it do?}
...
<<dbinom2-plot2, echo=2:6, w=8, h=4, out.width=".75\\textwidth", cap="Binomial distributions for $k=0, \\dots, 12$ successes in $n=12$ trials, and four values of $p$">>=
...
ratio goodness-of-fit (GOF) statistics. Plotting methods for visualizing
