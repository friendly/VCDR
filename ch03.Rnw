...
using a weighted least squares (LS) fit of \(k \,
...
\TODO{PC: I don't remember seeing the OLS or WLS accronyms defined above. Are this just not being
defined in text, and instead are placed in an index or something? I added the LS accronym in text,
