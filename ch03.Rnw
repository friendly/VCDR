...
<<arbuthnot1, echo=-1, h=4, w=7, out.width=".75\\textwidth", cap="Arbuthnot's data on male/female sex ratios in London, 1629--1710, together with a (loess) smoothed curve (blue) over time and the mean Pr(Male)", scap="Arbuthnot's data on male/female sex ratios">>=
