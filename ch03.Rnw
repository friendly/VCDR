...
<<arbuthnot1, h=4, w=6, out.width=".75\\textwidth", cap="Arbuthnot's data on male/female sex ratios in London, 1629--1710, together with a (loess) smoothed curve over time and the mean Pr(Male)", scap="Arbuthnot's data on male/female sex ratios">>=
spar()
...
<<saxony-barplot,w=8, h=4, out.width=".75\\textwidth", cap="Males in Saxony families of size 12">>=
spar()
...
\item \hard
  ...
  distribution of the number of dependencies declared in \Sexpr{sum(Depends)} \R packages
