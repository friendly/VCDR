...
<<sax-glm5, h=6, w=6, out.width=".6\\textwidth", cap='Rootogram for the double binomial model for the Saxony data. This now fits well in the tails of the distribution.'>>=
