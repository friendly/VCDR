...
%Marketing department wants to know this. I haven't yet done an analysis.

%\emph{Categorical Data Analysis Using the SAS System}
%%\cite{Stokes-etal:95}
%Similarly, \emph{Logistic Regression Examples Using the SAS System}
%treats logistic regression and related techniques, but primarily
