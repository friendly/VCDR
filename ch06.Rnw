...
<<ca-victims-plot, h=6, w=6, outwidth='.6\\textwidth', cap='2D CA solution for the repeat victimization data'>>=
...
<<ca-suicide-mosaic, h=6, w=6, out.width='.7\\textwidth', cap='Mosaic display showing deviations from the model [AgeSex][Method] for the suicide data', scap='Mosaic display showing deviations from the model AgeSex Method for the suicide data'>>=
