...
as an example of manipulating complex categorical data in \secref{working-complex}
...
others to the columns. However, those functions do not create a suitable
...
<<titanic-mca3, fig.keep='none', results='hide'>>=
