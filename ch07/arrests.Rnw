...
so charged, but particularly young black males, far outweighed their representation
in the population.
}
...
records for 5,226 cases of arrest on the charge of simple
...
and some two-way interactions. To allow for possible nonlinear effects of \var{year},
