...
<<arth-effplot1-bis, h=4, w=9, out.width='\\textwidth', cap='Plot of all effects in the main effects model for the Arthritis data. Partial residuals and their loess smooth are also shown for the continuous predictor, Age.', echo=FALSE, fig.pos="H">>=
...
<<arth-effplot1, h=4, w=9, out.width='\\textwidth', cap='Plot of all effects in the main effects model for the Arthritis data. Partial residuals and their loess smooth are also shown for the continuous predictor, Age.', eval=FALSE>>=
plot(arth.eff2, rows = 1, cols = 3,
     type="response", residuals.pch = 15)
@
...
\subsection{Simple models: Group comparisons and effect plots}\label{sec:complex}
\
