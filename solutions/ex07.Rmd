...
The data set Caesar in vcdExtra gives a 3?23 frequency table classifying 251
womho gave birth by Caesarian section by Infection (three levels: none, Type
...
(c) Interpret the coef.cients in the fitted model in terms of their effect on the odds of infection. 
