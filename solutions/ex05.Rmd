...
The data set `criminal` in the package logmult gives
...
<!-- [lab:mosaic-crash] -->
The data set `AirCrash` in vcdExtra gives a database of
...
<!-- [lab:mosaic-titanic]  -->
The dataset `Titanic` classifies the 2,201 pasengers
