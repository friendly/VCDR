...
<<nmes-school, h=5, w=6, out.width='.6\\textwidth', cap='Jitered scatterplot of physician office visits against number of years of education, with nonparametric (loess) smooth.'>>=
library(ggplot2)
...
regression splines
(as in \exref{ex:donner1}) or a \term{generalized additive model} \citep{HastieTibshiriani:1990}
