...
\begin{figure}[!htb]
\centering
\includegraphics[width=.75\textwidth]{ch08b/fig/tox-fourfold-crop}
...
plot(LOR, confidence=FALSE, legend_pos="bottomright", 
...
\begin{figure}
\centering
\includegraphics[width=.49\textwidth]{ch08b/fig/tox-glm-logits1}
\includegraphics[width=.49\textwidth]{ch08b/fig/tox-glm-logits2}
...
\begin{figure}
\centering
\includegraphics[width=.49\textwidth]{ch08b/fig/tox-glm-logits3}
