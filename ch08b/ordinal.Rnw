...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{ch08b/fig/assoc-models}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=.75\textwidth]{ch08b/fig/mental-lorplot}
...
@
Then, the $L \times L$, $R$ and $C$ models can be fit as follows, using \func{update}, where
...
vcdExtra::LRstats(indep, linlin, roweff, coleff)
@
...
\begin{figure}[!htb]
\centering
\includegraphics[width=.8\textwidth]{ch08b/fig/mental-RC1}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=.7\textwidth]{ch08b/fig/mental-RC2}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=.7\textwidth]{ch08b/fig/mental-logmult-rc2}
\caption{Scaled category scores for the RC(2) model fit
