...
\begin{figure}
\centering
\includegraphics[width=.49\textwidth]{ch08b/fig/cm-vglm1-prob}
\includegraphics[width=.49\textwidth]{ch08b/fig/cm-vglm1-logit}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=.8\textwidth]{ch08b/fig/cm-vglm2-blogit}
