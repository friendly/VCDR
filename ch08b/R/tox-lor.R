...
# FIXME: this no longer works because there is no t() method for loddsratio objects
# using oddsratio
...
plot(LOR, confidence=FALSE, legend_pos="bottomright", xlab="Social class of mother")
