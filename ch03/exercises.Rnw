\begin{Exercises}
  ...
  \begin{enumerate*}
    ...
    by a \LR test of the difference between these two models. \TODO{PC: correct me if I'm wrong, but aren't there models not nested? Wouldn't information criteria therefore be more appropriate?}
