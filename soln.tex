...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in sqrt(as.vector(object)): non-numeric argument to mathematical function}}\begin{alltt}
...
\centerline{\includegraphics[width=.5\textwidth]{soln/fig/ex5_2a-1} }
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(expr, envir, enclos): object 'family.size' not found}}\begin{alltt}
\hlstd{> }\hlkwd{Anova}\hlstd{(donner.mod4a)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in Anova(donner.mod4a): object 'donner.mod4a' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in allEffects(donner.mod4a, xlevels = list(age = seq(0, 50, 5))): object 'donner.mod4a' not found}}\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(donner.eff4a,} \hlkwc{ticks}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{n}\hlstd{=}\hlnum{8}\hlstd{))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in plot(donner.eff4a, ticks = list(n = 8)): error in evaluating the argument 'x' in selecting a method for function 'plot': Error: object 'donner.eff4a' not found}}\end{kframe}
\end{knitrout}
    \end{ans}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in poly(family.size, 2): object 'family.size' not found}}\begin{alltt}
\hlstd{> }\hlkwd{Anova}\hlstd{(donner.mod4b)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in Anova(donner.mod4b): object 'donner.mod4b' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in allEffects(donner.mod4b, xlevels = list(age = seq(0, 50, 5))): object 'donner.mod4b' not found}}\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(donner.eff4b,} \hlkwc{ticks}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{n}\hlstd{=}\hlnum{8}\hlstd{))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in plot(donner.eff4b, ticks = list(n = 8)): error in evaluating the argument 'x' in selecting a method for function 'plot': Error: object 'donner.eff4b' not found}}\end{kframe}
\end{knitrout}
    \end{ans}
...
86         Pre    2      C4 partial   high      few     healthy     1
92         Pre    2      B1      no   high      few     healthy     4
111        Pre    3      C1      no    low      few     healthy     2
135        Pre    3      B1      no   high      few     healthy     6
169 Incubation    4      C3 partial   high      few        dead     2
194 Incubation    4      B2      no   high moderate     healthy     1
253 Incubation    6      B1      no    mid      few     healthy     1
290 Incubation    8      C3      no    low moderate        dead     2
298 Incubation    8      B2      no    mid      few     healthy     1
\end{verbatim}
\end{kframe}
\end{knitrout}
	\begin{enumerate*}
