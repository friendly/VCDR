...
\hlstd{> }\hlkwd{str}\hlstd{(va.tab)}
\end{alltt}
\begin{verbatim}
 xtabs [1:4, 1:4, 1:2] 821 116 72 43 112 494 151 34 85 145 ...
 - attr(*, "dimnames")=List of 3
  ..$ right : chr [1:4] "1" "2" "3" "4"
  ..$ left  : chr [1:4] "1" "2" "3" "4"
  ..$ gender: chr [1:2] "male" "female"
 - attr(*, "class")= chr [1:2] "xtabs" "table"
 - attr(*, "call")= language xtabs(formula = Freq ~ ., data = VisualAcuity)
\end{verbatim}
\begin{alltt}
...
79         Pre    2      C3    full    mid      few        dead     1
106        Pre    2      B2 partial    mid moderate     healthy     1
164 Incubation    4      C3      no    mid moderate        dead     1
182 Incubation    4      B1      no   high      few        dead     3
...
274 Incubation    7      C3    full    mid      few     healthy     1
302 Incubation    9      C1      no   high      few     healthy     1
