...
Instructors should recognize that many questions are open-ended or admit to different
approaches. In many cases we simply present one reasonable approach.  

All \R code for the book, and other materials are available on the web site,
\url{http://ddar.datavis.ca}.

For the most part, \R code in answers indicates required packages with \func{library}
or \func{require}.  This document assumes, however, that the following packages are
loaded:
\textsf{AER},
\textsf{car},
\textsf{effects},
...
\end{knitrout}
    ...
    seen in the text for families of size 12 (\figref{fig:distplot3}).
\begin{knitrout}\footnotesize
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{distplot}\hlstd{(sax11.tab,} \hlkwc{type} \hlstd{=} \hlstr{"nbinomial"}\hlstd{,} \hlkwc{size} \hlstd{=} \hlnum{11}\hlstd{)}
...
\centerline{\includegraphics[width=.5\textwidth]{soln/fig/ex3_7d-1} }



\end{knitrout}
    The negative binomial is not a good choice either, as can be seen by the size of the residuals. In fact, the
    \term{double binomial distribution} will fit well, as illustrated in \exref{ex:saxony2}.
    \end{ans}
...
MCA plots are now simpler, using a new \func{mcaplot} function, presently in \pkg{vcdExtra}, and 
lines can be added to MCA plots using \func{multilines}.  Coordinates for CA/MCA plots can more
readily be extracted using \func{cacoord}.
...
\begin{alltt}
\hlstd{> }\hlkwd{library}\hlstd{(MASS)}
\hlstd{> }\hlstd{Vietnam}\hlopt{$}\hlstd{response} \hlkwb{=} \hlkwd{ordered}\hlstd{(Vietnam}\hlopt{$}\hlstd{response)}
\hlstd{> }\hlstd{Vtn_polr} \hlkwb{=} \hlkwd{polr}\hlstd{(response} \hlopt{~} \hlstd{year} \hlopt{*} \hlstd{sex,} \hlkwc{data} \hlstd{= Vietnam,}
\hlstd{+ }                \hlkwc{weights} \hlstd{= Freq,} \hlkwc{Hess} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\hlstd{> }\hlkwd{summary}\hlstd{(Vtn_polr)}
\end{alltt}
\begin{verbatim}
Call:
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{car}\hlopt{::}\hlkwd{Anova}\hlstd{(Vtn_polr)}
\end{alltt}
\begin{verbatim}
Analysis of Deviance Table (Type II tests)
...
\begin{alltt}
\hlstd{> }\hlkwd{library}\hlstd{(vcdExtra)}
\hlstd{> }\hlkwd{data}\hlstd{(DaytonSurvey)}
\hlstd{> }\hlstd{Dayton.ACM} \hlkwb{=} \hlkwd{aggregate}\hlstd{(Freq} \hlopt{~} \hlstd{cigarette} \hlopt{+} \hlstd{alcohol} \hlopt{+} \hlstd{marijuana,}
\hlstd{+ }                       \hlkwc{data} \hlstd{= DaytonSurvey,} \hlkwc{FUN} \hlstd{= sum)}
\hlstd{> }\hlstd{ACM.mutual} \hlkwb{=} \hlkwd{loglm}\hlstd{(Freq} \hlopt{~} \hlstd{.,} \hlkwc{data} \hlstd{= Dayton.ACM)}
\hlstd{> }\hlstd{ACM.mutual}
\end{alltt}
\begin{verbatim}
Call:
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mosaic}\hlstd{(Freq} \hlopt{~} \hlstd{.,} \hlkwc{data} \hlstd{= DaytonSurvey,} \hlkwc{shade} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.6\textwidth]{soln/fig/ex9_1b1-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Dayton.tab} \hlkwb{=} \hlkwd{xtabs}\hlstd{(Freq} \hlopt{~} \hlstd{.,} \hlkwc{data} \hlstd{= Dayton.ACM)}
\hlstd{> }\hlkwd{pairs}\hlstd{(Dayton.tab,} \hlkwc{type} \hlstd{=} \hlstr{"pairwise"}\hlstd{,} \hlkwc{shade} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex9_1b2-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{fourfold}\hlstd{(}\hlkwd{aperm}\hlstd{(Dayton.tab,} \hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{2}\hlstd{,} \hlnum{3}\hlstd{)))}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex9_1c1-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{fourfold}\hlstd{(}\hlkwd{aperm}\hlstd{(Dayton.tab,} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,} \hlnum{3}\hlstd{,} \hlnum{1}\hlstd{)))}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex9_1c2-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{fourfold}\hlstd{(}\hlkwd{aperm}\hlstd{(Dayton.tab,} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{2}\hlstd{)))}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex9_1c3-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{ACM.joint} \hlkwb{=} \hlkwd{loglm}\hlstd{(Freq} \hlopt{~} \hlstd{alcohol} \hlopt{*} \hlstd{cigarette} \hlopt{+} \hlstd{marijuana,} \hlkwc{data} \hlstd{= Dayton.ACM)}
\hlstd{> }\hlstd{ACM.joint}
\end{alltt}
\begin{verbatim}
Call:
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{ACM.cond} \hlkwb{=} \hlkwd{loglm}\hlstd{(Freq} \hlopt{~} \hlstd{(alcohol} \hlopt{+} \hlstd{cigarette)} \hlopt{*} \hlstd{marijuana,} \hlkwc{data} \hlstd{= Dayton.ACM)}
\hlstd{> }\hlstd{ACM.cond}
\end{alltt}
\begin{verbatim}
Call:
loglm(formula = Freq ~ (alcohol + cigarette) * marijuana, data = Dayton.ACM)
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{ACM.hom} \hlkwb{=} \hlkwd{loglm}\hlstd{(Freq} \hlopt{~} \hlstd{alcohol} \hlopt{*} \hlstd{cigarette} \hlopt{+} \hlstd{alcohol} \hlopt{*} \hlstd{marijuana} \hlopt{+}
\hlstd{+ }                \hlstd{cigarette} \hlopt{*} \hlstd{marijuana,} \hlkwc{data} \hlstd{= Dayton.ACM)}
\hlstd{> }\hlstd{ACM.hom}
\end{alltt}
\begin{verbatim}
Call:
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(ACM.mutual, ACM.joint, ACM.cond, ACM.hom,} \hlkwc{test} \hlstd{=} \hlstr{"Chisq"}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{LRstats}\hlstd{(ACM.mutual, ACM.joint, ACM.cond, ACM.hom)}
\end{alltt}
\begin{verbatim}
Likelihood summary table:
            AIC  BIC LR Chisq Df Pr(>Chisq)    
...
\begin{alltt}
\hlstd{> }\hlkwd{library}\hlstd{(vcdExtra)}
\hlstd{> }\hlkwd{data}\hlstd{(Caesar)}
\hlstd{> }\hlkwd{mosaic}\hlstd{(}\hlkwd{aperm}\hlstd{(Caesar,} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{4}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{)))}
\hlstd{> }\hlkwd{structable}\hlstd{(}\hlkwd{aperm}\hlstd{(Caesar,} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{4}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{)))}
\end{alltt}
\begin{verbatim}
                      Planned Yes     No   
                      Risk    Yes No Yes No
...
\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex09_3a-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{caesar_base} \hlkwb{=} \hlkwd{loglm}\hlstd{(}\hlopt{~} \hlstd{Infection} \hlopt{+} \hlstd{Planned} \hlopt{*} \hlstd{Risk} \hlopt{*} \hlstd{Antibiotics,} \hlkwc{data} \hlstd{= Caesar)}
\hlstd{> }\hlstd{caesar_base}
\end{alltt}
\begin{verbatim}
Call:
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Caesar1} \hlkwb{=} \hlstd{Caesar} \hlopt{+} \hlnum{0.5}
\hlstd{> }\hlstd{caesar_sampling} \hlkwb{=} \hlkwd{loglm}\hlstd{(}\hlopt{~} \hlstd{Infection} \hlopt{+} \hlstd{Planned} \hlopt{*} \hlstd{Risk} \hlopt{*} \hlstd{Antibiotics,} \hlkwc{data} \hlstd{= Caesar1)}
\hlstd{> }\hlstd{caesar_sampling}
\end{alltt}
\begin{verbatim}
Call:
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{caesar_main} \hlkwb{=} \hlkwd{loglm}\hlstd{(}\hlopt{~} \hlstd{Infection} \hlopt{*} \hlstd{(Risk} \hlopt{+} \hlstd{Antibiotics} \hlopt{+} \hlstd{Planned)} \hlopt{+}
\hlstd{+ }\hlstd{(Risk} \hlopt{*} \hlstd{Antibiotics} \hlopt{*} \hlstd{Planned),} \hlkwc{data} \hlstd{= Caesar1)}
\hlstd{> }\hlstd{caesar_main}
\end{alltt}
\begin{verbatim}
Call:
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(caesar_sampling, caesar_main,} \hlkwc{test} \hlstd{=} \hlstr{"Chisq"}\hlstd{)}
\end{alltt}
\begin{verbatim}
LR tests for hierarchical log-linear models
...
\begin{alltt}
\hlstd{> }\hlkwd{library}\hlstd{(vcdExtra)}
\hlstd{> }\hlkwd{pairs}\hlstd{(Detergent,} \hlkwc{type} \hlstd{=} \hlstr{"pairwise"}\hlstd{)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex09_4a1-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mosaic}\hlstd{(}\hlopt{~} \hlstd{Preference} \hlopt{+} \hlstd{M_User} \hlopt{+} \hlstd{Temperature} \hlopt{+} \hlstd{Water_softness,} \hlkwc{data}
\hlstd{+ }\hlstd{= Detergent)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex09_4a2-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mosaic}\hlstd{(}\hlopt{~} \hlstd{Temperature} \hlopt{+} \hlstd{Water_softness} \hlopt{+} \hlstd{M_User} \hlopt{+} \hlstd{Preference,} \hlkwc{data}
\hlstd{+ }\hlstd{= Detergent)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex09_4a3-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{doubledecker}\hlstd{(Preference} \hlopt{~} \hlstd{M_User} \hlopt{+} \hlstd{Temperature} \hlopt{+} \hlstd{Water_softness,} \hlkwc{data} \hlstd{= Detergent)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex09_4b-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{detergent_base} \hlkwb{=} \hlkwd{loglm}\hlstd{(}\hlopt{~} \hlstd{Preference} \hlopt{+} \hlstd{Temperature} \hlopt{*} \hlstd{M_User} \hlopt{*}
\hlstd{+ }                       \hlstd{Water_softness,} \hlkwc{data} \hlstd{= Detergent)}
\hlstd{> }\hlstd{detergent_base}
\end{alltt}
\begin{verbatim}
Call:
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{mosaic}\hlstd{(detergent_base)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex09_4c1-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{detergent_model2} \hlkwb{=} \hlkwd{loglm}\hlstd{(}\hlopt{~} \hlstd{Preference} \hlopt{*} \hlstd{M_User} \hlopt{+} \hlstd{Temperature} \hlopt{*}
\hlstd{+ }                         \hlstd{Water_softness,} \hlkwc{data} \hlstd{= Detergent)}
\hlstd{> }\hlstd{detergent_model2}
\end{alltt}
\begin{verbatim}
Call:
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{quine.tab} \hlkwb{<-} \hlkwd{xtabs}\hlstd{(}\hlopt{~} \hlstd{Lrn} \hlopt{+} \hlstd{Age} \hlopt{+} \hlstd{Sex} \hlopt{+} \hlstd{Eth,} \hlkwc{data}\hlstd{=quine)}
\hlstd{> }\hlkwd{ftable}\hlstd{(Age} \hlopt{+} \hlstd{Sex} \hlopt{~} \hlstd{Lrn} \hlopt{+} \hlstd{Eth,} \hlkwc{data}\hlstd{=quine.tab)}
\end{alltt}
\begin{verbatim}
        Age F0    F1    F2    F3   
        Sex  F  M  F  M  F  M  F  M
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{data}\hlstd{(}\hlstr{"quine"}\hlstd{,} \hlkwc{package}\hlstd{=}\hlstr{"MASS"}\hlstd{)}
\hlstd{> }\hlstd{quine}\hlopt{$}\hlstd{Age} \hlkwb{<-} \hlkwd{ordered}\hlstd{(quine}\hlopt{$}\hlstd{Age)}
\hlstd{> }\hlstd{quine.mod1} \hlkwb{<-} \hlkwd{glm}\hlstd{(Days} \hlopt{~} \hlstd{.,} \hlkwc{data}\hlstd{=quine,} \hlkwc{family}\hlstd{=poisson)}
\hlstd{> }\hlkwd{Anova}\hlstd{(quine.mod1)}
\end{alltt}
\begin{verbatim}
Analysis of Deviance Table (Type II tests)
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{AirCrash}\hlopt{$}\hlstd{Phase} \hlkwb{<-} \hlkwd{factor}\hlstd{(AirCrash}\hlopt{$}\hlstd{Phase,}
\hlstd{+ }                \hlkwc{levels}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"standing"}\hlstd{,} \hlstr{"take-off"}\hlstd{,} \hlstr{"en route"}\hlstd{,} \hlstr{"landing"}\hlstd{,} \hlstr{"unknown"}\hlstd{))}
\hlstd{> }\hlkwd{with}\hlstd{(AirCrash, \{}
\hlstd{+ }     \hlkwd{plot}\hlstd{(}\hlkwd{jitter}\hlstd{(Fatalities}\hlopt{+}\hlnum{1}\hlstd{)} \hlopt{~} \hlstd{Year,} \hlkwc{log}\hlstd{=}\hlstr{"y"}\hlstd{,}
\hlstd{+ }          \hlkwc{ylab} \hlstd{=} \hlstr{"log(Fatalities + 1)"}\hlstd{,} \hlkwc{cex.lab}\hlstd{=}\hlnum{1.25}\hlstd{)}
\hlstd{+ }     \hlkwd{lines}\hlstd{(}\hlkwd{lowess}\hlstd{(Year, Fatalities}\hlopt{+}\hlnum{1}\hlstd{),} \hlkwc{col}\hlstd{=}\hlstr{"blue"}\hlstd{,} \hlkwc{lwd}\hlstd{=}\hlnum{2}\hlstd{)}
\hlstd{+ }                \hlstd{\})}
\hlstd{> }
\hlstd{> }\hlkwd{plot}\hlstd{(Fatalities} \hlopt{~} \hlkwd{cutfac}\hlstd{(Year),} \hlkwc{data}\hlstd{=AirCrash,} \hlkwc{log}\hlstd{=}\hlstr{"y"}\hlstd{,}
\hlstd{+ }     \hlkwc{ylab} \hlstd{=} \hlstr{"log(Fatalities)"}\hlstd{,} \hlkwc{xlab}\hlstd{=}\hlstr{"Year (deciles)"}\hlstd{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{data}\hlstd{(}\hlstr{"CodParasites"}\hlstd{,} \hlkwc{package} \hlstd{=} \hlstr{"countreg"}\hlstd{)}
\hlstd{> }
\hlstd{> }\hlcom{## omit NAs in response}
\hlstd{> }\hlstd{CodParasites} \hlkwb{<-} \hlkwd{subset}\hlstd{(CodParasites,} \hlopt{!}\hlkwd{is.na}\hlstd{(intensity))}
\hlstd{> }
\hlstd{> }\hlcom{# make a numeric variable from area}
\hlstd{> }\hlstd{CodParasites}\hlopt{$}\hlstd{areaEW} \hlkwb{<-} \hlkwd{as.numeric}\hlstd{(CodParasites}\hlopt{$}\hlstd{area)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\begin{alltt}
\hlstd{> }\hlkwd{library}\hlstd{(MASS)}
\hlstd{> }\hlstd{cp_nb}     \hlkwb{<-} \hlkwd{glm.nb}\hlstd{(intensity} \hlopt{~} \hlstd{length} \hlopt{+} \hlstd{area} \hlopt{*} \hlstd{year,} \hlkwc{data} \hlstd{= CodParasites)}
\hlstd{> }\hlstd{cp_nb_lin} \hlkwb{<-} \hlkwd{glm.nb}\hlstd{(intensity} \hlopt{~} \hlstd{length} \hlopt{+} \hlstd{areaEW} \hlopt{*} \hlstd{year,} \hlkwc{data} \hlstd{= CodParasites)}
\hlstd{> }\hlkwd{Anova}\hlstd{(cp_nb_lin)}
\end{alltt}
\begin{verbatim}
Analysis of Deviance Table (Type II tests)
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(cp_nb_lin, cp_nb,} \hlkwc{test}\hlstd{=}\hlstr{"Chisq"}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{CodParasites} \hlkwb{<-} \hlkwd{subset}\hlstd{(CodParasites, sex} \hlopt{!=}\hlnum{0}\hlstd{)}
\hlstd{> }\hlstd{CodParasites}\hlopt{$}\hlstd{sex} \hlkwb{<-} \hlkwd{factor}\hlstd{(CodParasites}\hlopt{$}\hlstd{sex,} \hlkwc{labels}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"male"}\hlstd{,} \hlstr{"female"}\hlstd{))}
\hlstd{> }
\hlstd{> }\hlstd{op} \hlkwb{<-}\hlkwd{par}\hlstd{(}\hlkwc{mfrow} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,} \hlnum{2}\hlstd{),} \hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{4}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{)}\hlopt{+}\hlnum{.1}\hlstd{)}
\hlstd{> }\hlkwd{plot}\hlstd{(prevalence} \hlopt{~} \hlstd{depth,} \hlkwc{data} \hlstd{= CodParasites)}
\hlstd{> }\hlkwd{plot}\hlstd{(prevalence} \hlopt{~} \hlstd{weight,} \hlkwc{data} \hlstd{= CodParasites)}
\hlstd{> }\hlkwd{plot}\hlstd{(prevalence} \hlopt{~} \hlstd{length,} \hlkwc{data} \hlstd{= CodParasites)}
\hlstd{> }\hlkwd{plot}\hlstd{(prevalence} \hlopt{~} \hlstd{sex,} \hlkwc{data} \hlstd{= CodParasites)}
\hlstd{> }\hlkwd{par}\hlstd{(op)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex11_6a-1} }
...
\hlstd{> }
\hlstd{> }\hlstd{phd.nbin}  \hlkwb{<-} \hlkwd{glm.nb}\hlstd{(articles} \hlopt{~} \hlstd{.,} \hlkwc{data}\hlstd{=PhdPubs)}
\hlstd{> }  \hlcom{# hurdle and zero-inflated}
\hlstd{> }\hlstd{phd.hp}    \hlkwb{<-} \hlkwd{hurdle}\hlstd{(articles} \hlopt{~} \hlstd{.,} \hlkwc{data}\hlstd{=PhdPubs,} \hlkwc{dist} \hlstd{=} \hlstr{"poisson"}\hlstd{)}
\hlstd{> }\hlstd{phd.hnb}   \hlkwb{<-} \hlkwd{hurdle}\hlstd{(articles} \hlopt{~} \hlstd{.,} \hlkwc{data}\hlstd{=PhdPubs,} \hlkwc{dist} \hlstd{=} \hlstr{"negbin"}\hlstd{)}
\hlstd{> }\hlstd{phd.zp}    \hlkwb{<-} \hlkwd{zeroinfl}\hlstd{(articles} \hlopt{~} \hlstd{.,} \hlkwc{data}\hlstd{=PhdPubs,} \hlkwc{dist} \hlstd{=} \hlstr{"poisson"}\hlstd{)}
\hlstd{> }\hlstd{phd.znb}   \hlkwb{<-} \hlkwd{zeroinfl}\hlstd{(articles} \hlopt{~} \hlstd{.,} \hlkwc{data}\hlstd{=PhdPubs,} \hlkwc{dist} \hlstd{=} \hlstr{"negbin"}\hlstd{)}
\hlstd{> }
\hlstd{> }\hlkwd{LRstats}\hlstd{(phd.nbin, phd.hp, phd.hnb, phd.zp, phd.znb,}  \hlkwc{sortby}\hlstd{=}\hlstr{"BIC"}\hlstd{)}
\end{alltt}
\begin{verbatim}
Likelihood summary table:
          AIC  BIC LR Chisq  Df Pr(>Chisq)    
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(phd.znb)}
\end{alltt}
\begin{verbatim}
...
Zero-inflation model coefficients (binomial with logit link):
            Estimate Std. Error z value Pr(>|z|)   
(Intercept)  -0.2943     1.2827   -0.23   0.8185   
female        0.6580     0.8557    0.77   0.4419   
married      -1.4741     0.9176   -1.61   0.1082   
kid5          0.6241     0.4410    1.42   0.1570   
phdprestige  -0.0113     0.2888   -0.04   0.9689   
mentor       -0.8765     0.3152   -2.78   0.0054 **
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{phd.znb1}   \hlkwb{<-} \hlkwd{zeroinfl}\hlstd{(articles} \hlopt{~} \hlstd{.}\hlopt{|} \hlstd{mentor,} \hlkwc{data}\hlstd{=PhdPubs,} \hlkwc{dist} \hlstd{=} \hlstr{"negbin"}\hlstd{)}
\hlstd{> }\hlkwd{LRstats}\hlstd{(phd.znb, phd.znb1)}
\end{alltt}
\begin{verbatim}
Likelihood summary table:
          AIC  BIC LR Chisq  Df Pr(>Chisq)    
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{phd.zero} \hlkwb{<-}  \hlkwd{glm}\hlstd{(articles}\hlopt{==}\hlnum{0} \hlopt{~}\hlstd{.,} \hlkwc{data}\hlstd{=PhdPubs,} \hlkwc{family} \hlstd{= binomial)}
\hlstd{> }\hlkwd{Anova}\hlstd{(phd.zero)}
\end{alltt}
\begin{verbatim}
Analysis of Deviance Table (Type II tests)
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{phd.nzero} \hlkwb{<-} \hlkwd{glm.nb}\hlstd{(articles} \hlopt{~} \hlstd{.,} \hlkwc{data}\hlstd{=PhdPubs,} \hlkwc{subset} \hlstd{= articles} \hlopt{>} \hlnum{0}\hlstd{)}
\hlstd{> }\hlkwd{Anova}\hlstd{(phd.nzero)}
\end{alltt}
\begin{verbatim}
Analysis of Deviance Table (Type II tests)
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(}\hlkwd{Effect}\hlstd{(}\hlstr{"mentor"}\hlstd{, phd.zero))}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.5\textwidth]{soln/fig/ex11_7b1-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(}\hlkwd{allEffects}\hlstd{(phd.nzero)[}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{5}\hlstd{)],} \hlkwc{rows}\hlstd{=}\hlnum{1}\hlstd{,} \hlkwc{cols}\hlstd{=}\hlnum{3}\hlstd{)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.8\textwidth]{soln/fig/ex11_7b2-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{op} \hlkwb{<-} \hlkwd{par}\hlstd{(}\hlkwc{mfrow}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{),} \hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{4}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{)}\hlopt{+}\hlnum{.1}\hlstd{)}
\hlstd{> }\hlkwd{residualPlot}\hlstd{(phd.zero,} \hlkwc{type}\hlstd{=}\hlstr{"rstandard"}\hlstd{,}
\hlstd{+ }             \hlkwc{quadratic}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{col.smooth}\hlstd{=}\hlstr{"red"}\hlstd{,} \hlkwc{col.quad}\hlstd{=}\hlstr{"blue"}\hlstd{,}  \hlkwc{id.n}\hlstd{=}\hlnum{3}\hlstd{)}
\hlstd{> }
\hlstd{> }\hlkwd{residualPlot}\hlstd{(phd.zero,} \hlstr{"mentor"}\hlstd{,} \hlkwc{type}\hlstd{=}\hlstr{"rstandard"}\hlstd{,}
\hlstd{+ }             \hlkwc{quadratic}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{col.smooth}\hlstd{=}\hlstr{"red"}\hlstd{,} \hlkwc{col.quad}\hlstd{=}\hlstr{"blue"}\hlstd{,}  \hlkwc{id.n}\hlstd{=}\hlnum{3}\hlstd{)}
\hlstd{> }\hlkwd{par}\hlstd{(op)}
\end{alltt}
\end{kframe}

\centerline{\includegraphics[width=.9\textwidth]{soln/fig/ex11_7c1-1} }
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{influencePlot}\hlstd{(phd.nzero)}
\end{alltt}
\begin{verbatim}
    StudRes      Hat    CookD
...
\centerline{\includegraphics[width=.5\textwidth]{soln/fig/ex_11_7c2-1} }
