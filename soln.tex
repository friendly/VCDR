...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in library(countreg): there is no package called 'countreg'}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(expr, envir, enclos): could not find function "{}zerotrunc"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in loadNamespace(name): there is no package called 'countreg'}}\begin{alltt}
\hlstd{> }\hlstd{countreg}\hlopt{::}\hlkwd{rootogram}\hlstd{(hof.zerot1)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in loadNamespace(name): there is no package called 'countreg'}}\end{kframe}
\end{knitrout}
...
\centerline{\includegraphics[width=.7\textwidth]{soln/fig/ex5_9b-1} }
