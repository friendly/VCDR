...
\centerline{\includegraphics[width=.5\textwidth]{soln/fig/ex4_5a-1} 
\includegraphics[width=.5\textwidth]{soln/fig/ex4_5a-2} 
\includegraphics[width=.5\textwidth]{soln/fig/ex4_5a-3} 
\includegraphics[width=.5\textwidth]{soln/fig/ex4_5a-4} }
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in agreementplot(Ratings): object 'Ratings' not found}}\end{kframe}
\end{knitrout}
     \end{ans}
...
(Intercept)                       4.67e+07   1.10e+07    4.24
sideStarboard                    -3.39e+07   1.48e+07   -2.29
as.numeric(launch)                2.56e-02   6.05e-03    4.24
sideStarboard:as.numeric(launch) -1.86e-02   8.12e-03   -2.29
                                 Pr(>|t|)    
(Intercept)                       0.00083 ***
sideStarboard                     0.03800 *  
as.numeric(launch)                0.00083 ***
sideStarboard:as.numeric(launch)  0.03800 *  
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
\end{knitrout}
  ...
  \begin{enumerate*}
    ...
    \begin{ans}
    %TODO{This example gives an out-of-memory error with \pkg{ca} v.0.64}
\begin{knitrout}\footnotesize
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
Percentage 80.47%   3.99%    0% 0% 0%
 ...
 Columns:
        Admit:Admitted Admit:Rejected Gender:Female Gender:Male
Mass           0.12925       0.204080      0.135145     0.19819
ChiDist        0.79221       0.501745      0.783694     0.53440
Inertia        0.08112       0.051377      0.083003     0.05660
Dim. 1         1.07559      -0.681222     -1.175453     0.80154
Dim. 2         0.97498      -0.617499      0.786218    -0.53612
          Dept:A    Dept:B    Dept:C    Dept:D    Dept:E
Mass    0.068714  0.043084  0.067609  0.058330  0.043011
ChiDist 1.221480  1.584797  1.179839  1.257459  1.541085
Inertia 0.102522  0.108210  0.094114  0.092231  0.102148
Dim. 1  1.508902  1.691541 -0.797163 -0.323064 -1.132444
Dim. 2  0.167342 -0.595723  1.717196  0.088564  0.908371
           Dept:F
Mass     0.052585
ChiDist  1.390552
Inertia  0.101680
