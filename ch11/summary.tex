...
%    \item common distributions have a known mean-variance relation, but the GLM allows further extensions.
  ...
  \begin{itemize*}
    \item One simple approach to this problem is the quasi-Poisson model, which estimates the dispersion
  ...
  \begin{itemize*}
    \item zero-inflated models, which posit a latent class of observations that always yield $y_i=0$
