...
\citet[ Section 10.5.3]{Agresti:2013},
...
<<sexfun-agree, echo=2:3, h=6, w=6, out.width='.48\\textwidth', cap="Agreement charts for husbands' and wives' sexual fun. Left: unweighted chart, showing only exact agreement; right: weighted chart, using weight $w_1 = 8/9$ for a one-step disagreement.", fig.pos="H">>=
...
ggtern(data = Lifeboats,
     ...
     geom_smooth(session inmethod="lm", size=1.5, aes(fill=side), alpha=0.2) +
     geom_text(vjust=1, color="black") 
@
