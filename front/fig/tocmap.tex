...
\begin{document}
  \begin{tikzpicture}[grow cyclic, text width=2cm, align=flush center, every node/.style=concept, concept color=blue!40, minimum size=2cm,
    root concept/.style={minimum size=5cm},
    level 1/.style={level distance=7cm,sibling angle=120},
    level 2/.style={level distance=4cm,sibling angle=45}]
    \sffamily

    \node[root concept]{\textbf{\Large Discrete Data \mbox{Analysis} with R}} [clockwise from=60]  % root node
    child [concept color=col1!60] { node {\large I. Getting Started}
      [clockwise from=105]
