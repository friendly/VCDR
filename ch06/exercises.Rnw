\begin{Exercises}
  ...
  \begin{enumerate*}
    \item Carry out similar \ca  to the last exercise 
  ...
  school boys classified according to their clothing and their teachers rating of ``dullness'' (lack of intelligence).
  \begin{enumerate*}
