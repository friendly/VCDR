...
<<count-data, child='ch11/crabs1.Rnw'>>=
@
...
<<phdpubs5-plot, h=8, w=8, out.width='.7\\textwidth', cap='Default diagnostic plots for the negative-binomial model fit to the PhdPubs data.'>>=
...
residualPlot(phd.nbin, type="rstandard",
             groups=PhdPubs$articles, key=FALSE, linear=FALSE, smoother=NULL)
@
