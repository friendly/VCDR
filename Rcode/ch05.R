...
## ----exercises05, child="ch05/exercises.Rnw"-----------------------------
...
.locals$ch05 <- setdiff(ls(), .globals)
#.locals$ch05
remove(list=.locals$ch05[sapply(.locals$ch05,function(n){!is.function(get(n))})])
.pkgs$ch05 <- setdiff(.packages(), .base.pkgs)
