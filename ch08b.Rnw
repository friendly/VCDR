...
%\input{ch08b/vtoc}		% visual table of contents
...
<<multiv, child='ch08b/multiv.Rnw'>>=
@

<<coalminers-ex, child='ch08b/coalminers.Rnw'>>=
@
...
<<tox-ex, child='ch08b/toxaemia.Rnw'>>=
@
...
<<exercises08b, child="ch08b/exercises.Rnw">>=

% Cleanup local variables
<<cleanupXX, size='footnotesize'>>=
# detach(package:ggtern)  ## detach any masking packages
.locals$ch08b <- setdiff(ls(), .globals)
.locals$ch08b
remove(list=.locals$ch08b[sapply(.locals$ch08b,function(n){!is.function(get(n))})]) 
