...
mosaic(berk.glm1, shade = TRUE, 
       ...
       residuals_type = "rstandard", main = "Model: [AdmitDept][GenderDept]", 
       labeling = labeling_residuals, abbreviate_labs = c(Gender = TRUE),
...
<<berk-glm3-mosaic, fig.pos='!htb', h=6, w=8, out.width='.7\\textwidth', cap='Mosaic display for the model \\code{berk.glm3}, allowing an association of gender and admission in Department A. This model now fits the data well.', scap='Mosaic display for the model berk.glm3'>>=
