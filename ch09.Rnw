...
<<berk-glm3-mosaic-bis, fig.pos='!htb', h=6, w=8, out.width='.7\\textwidth', cap='Mosaic display for the model \\code{berk.glm3}, allowing an association of gender and admission in Department A. This model now fits the data well.', scap='Mosaic display for the model berk.glm3', echo=FALSE, fig.pos="H">>=
...
<<berk-glm3-mosaic, fig.pos='!htb', h=6, w=8, out.width='.7\\textwidth', cap='Mosaic display for the model \\code{berk.glm3}, allowing an association of gender and admission in Department A. This model now fits the data well.', scap='Mosaic display for the model berk.glm3', eval=FALSE>>=
mosaic(berk.glm3, shade = TRUE, 
       formula = ~ Dept + Admit + Gender, split = TRUE,
       residuals_type = "rstandard", 
       main = "Model: [DeptGender][DeptAdmit] + DeptA*[GA]",
